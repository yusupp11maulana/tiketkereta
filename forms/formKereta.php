...
<html>
    ...
    <body>
        ...
        <h1>Insert Kereta</h1>
        <form action="../proses/prosesKereta.php?aksi=tambah" method="post">
            <label >Kode Kereta :</label>
            <input type="text" id="kodeket" name="kodeket" placeholder="Kode Kereta" style="margin-left: 5px"><br><br>
