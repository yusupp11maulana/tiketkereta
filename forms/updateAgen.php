...
<html>
    ...
    <body>
        ...
        <h1>Insert Agen</h1>
        <form action="../proses/prosesAgen.php?aksi=ubah&id=<?php echo $kodene?>" method="post">
            <label >Masukkan ID Agen :</label>
            <input type="text" id="noagen" name="noagen" value="<?php echo $kodene?>" disabled><br><br>
            <label >Nama Agen :</label>
            <input type="text" id="namagen" name="namagen" value="<?php echo $nama?>" style="margin-left: 50px"><br><br>
            ...
            <label >Alamat :</label>
            <input type="text" id="almt" name="almt" value="<?php echo $alamat?>" style="margin-left: 78px"><br><br>
            <label >No. Telp :</label>
            <input type="text" id="notelp" name="notelp" value="<?php echo $telp?>" style="margin-left: 70px"><br>
