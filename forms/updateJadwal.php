...
<html>
    ...
    <body>
        ...
        <h1>Insert jadwal</h1>
        <form action="../proses/prosesJadwal.php?aksi=ubah&id=<?php echo $id?>&kd=<?php echo $kd?>" method="post">
            <label >Masukkan ID Jadwal :</label>
            <input type="text" id="nojd" name="nojd" value="<?php echo $id?>" disabled style="margin-left: 8px"><br><br>
            <label >Kode Kereta :</label>
            <input type="text" id="kodeket" name="kodeket" value="<?php echo $kd?>" disabled style="margin-left: 62px"><br><br>
